            ...
            <div class="header__middle ul_li_between justify-content-xs-center">
                <div class="header__logo">
                    <router-link to="/trang-chu">
                        <a href="#">
                            <img src="../../assets/client/img/logo/logo.svg" alt="">
                        </a>
                ...
                <div class="header__lang ul_li">
                    ...
                    <div class="header__language">
                        <ul>
                            <li><a href="#!" class="lang-btn"><img src="../../assets/client/img/icon/usd_flag.png" alt="">English
                ...
                <div class="header__icons ul_li">
                    <div class="icon">
                        ...
                        <a href="#!"><img src="../../assets/client/img/icon/user.svg" alt=""></a>
                        </router-link>
                    </div>
                    ...
                    <div class="cart_btn icon">
                        <img src="../../assets/client/img/icon/shopping_bag.svg" alt="">
                        <span class="count">0</span>
                    </div>
                </div>
            </div>
                ...
                <div class="header__wrap ul_li_between">
                    <div class="header__cat ul_li">
                        ...
                        <ul class="category ul_li">
                            <li><a href="#!"><span><img src="../../assets/client/img/icon/hc_01.svg" alt=""></span>Laptops &
                                    Computers</a></li>
                            <li><a href="#!"><span><img src="../../assets/client/img/icon/hc_02.svg" alt=""></span>CC Tv &
                                    Camera</a></li>
                            <li><a href="#!"><span><img src="../../assets/client/img/icon/hc_03.svg" alt=""></span>Home
                                    Equipment</a></li>
                            <li><a href="#!"><span><img src="../../assets/client/img/icon/hc_04.svg" alt=""></span>Tv &
                                    Audios</a></li>
                            <li><a href="#!"><span><img src="../../assets/client/img/icon/hc_05.svg" alt=""></span>Printers &
                                    Ink</a></li>
                            <li><a href="#!"><span><img src="../../assets/client/img/icon/hc_06.svg" alt=""></span>Gaming &
                                    Fun</a></li>
                        </ul>
                    </div>
